...
// this is messy. i gotta rename them later
func DatabaseFeedsFollowsToFeedsFollows(dbFeedFollowsList []database.FeedFollow) []FeedFollows {
	FeedsFollows := []FeedFollows{}
	for _, dbFF := range dbFeedFollowsList {
		FeedsFollows = append(FeedsFollows, DatabaseFeedFollowsToFeedFollows(dbFF))
	}
	return FeedsFollows
}
